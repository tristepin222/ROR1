...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { name: @classroom.name, number: @classroom.number, room: @classroom.room } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { name: @classroom.name, number: @classroom.number, room: @classroom.room } }
