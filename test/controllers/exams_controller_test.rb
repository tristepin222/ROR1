...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { coefficient: @exam.coefficient, date: @exam.date, subject_id: @exam.subject_id, title: @exam.title } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { coefficient: @exam.coefficient, date: @exam.date, subject_id: @exam.subject_id, title: @exam.title } }
